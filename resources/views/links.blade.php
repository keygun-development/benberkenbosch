...
<div class="flex-1 mx-auto grid grid-cols-2 lg:grid-cols-4 gap-4 pb-4 md:gap-8 justify-center mt-14">
    ...
    <a href="https://music.amazon.com/artists/B09B4Z7BPD/ben-berkenbosch" target="_blank" class="link-button bg-[#00a8e1] hover:shadow-[0_10px_20px_rgba(0,168,225,_0.5)]">
        <div>
    ...
    <a href="https://www.tiktok.com/@benberkenbosch" target="_blank" class="link-button bg-[#222222] hover:shadow-[0_10px_20px_rgba(120,120,120,_0.5)]">
        <div>
