                ...
                <div class="page prose">
                    <div class="translations-content-container">
                        <div class="tab-content translations-content-item en visible" id="en">
                            ...
                            <ul>
                                ...
                                <li>
                                    <p><strong>Company</strong> (referred to as either "the Company", "We", "Us" or
                                        "Our" in this Agreement) refers to Ben Berkenbosch.</p>
                                </li>
                                <li>
                                ...
                                <li>
                                    <p><strong>Website</strong> refers to Ben Berkenbosch, accessible from <a
                                            href="https://benberkenbosch.com" rel="external nofollow noopener"
                                            target="_blank">https://benberkenbosch.com</a></p>
                                </li>
                                <li>
                            ...
                            <ul>
                                <li>By email: info.benberkenbosch@gmail.com</li>
                            </ul>
                        </div>
                    </div>
                </div>
